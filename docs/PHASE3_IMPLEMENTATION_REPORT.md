...
|---|---|---|---|---|
| pytest (Phase 1 frozen + Phase 2 frozen + Phase 3) | 136 | 136 | 0 | 0 |
...
Phase-1 and Phase-2 tests were not deleted or weakened; the historical 66-test regression suite runs unchanged as part of the 136.
